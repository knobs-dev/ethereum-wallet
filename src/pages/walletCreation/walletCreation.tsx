...
const WalletCreation: FunctionComponent<WalletCreationProps> = ({
    ...
    if (isImport) {
        ...
        if (wallet?.address && isImport === true) history.push('/wallet');
    }
                    ...
                    <Center height='100%'>
                        {creationStep === CreationSteps.INITIAL && (
                            <BasicSlide
                                ...
                                description={t(
                                    'wallet_creation.description_address',
                                )}
                        ...
                        {creationStep === CreationSteps.PRIVATE_KEY &&
                            !wallet && (
                                <BasicSlide
                                    title={t('wallet_creation.wallet_key')}
                                    imageSource='/images/private-key.svg'
                                    description={t(
                                        'wallet_creation.description_key',
                                    )}
                        ...
                        {creationStep === CreationSteps.PRIVATE_KEY && wallet && (
                            <BasicSlide
                                title={t(
                                    'wallet_creation.basic_slide_key.title',
                                )}
                                description={t(
                                    'wallet_creation.basic_slide_key.description',
                                )}
                                buttonText={t(
                                    'wallet_creation.basic_slide_key.button_text',
                                )}
                        ...
                        {creationStep === CreationSteps.PUBLIC_KEY && wallet && (
                            <BasicSlide
                                title={t(
                                    'wallet_creation.basic_slide_address.title',
                                )}
                                description={t(
